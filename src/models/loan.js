...
module.exports = (sequelize, DataTypes) => {
  const Loan = sequelize.define('Loan', {
    ...
    productId:  { type: DataTypes.INTEGER, allowNull: true }, // link to loan_products
    ...
    // ✅ used across UI/controllers for schedule/validation
    ...
    // ✅ include all statuses your UI filters on
    status: {
  ...
  Loan.associate = (models) => {
    ...
    // Product link for UI exports/details
