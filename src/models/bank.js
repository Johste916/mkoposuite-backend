...
module.exports = (sequelize, DataTypes) => {
  const Bank = sequelize.define('Bank', {
    ...
    // legacy mirrors (DBs might still have these camelCase columns)
    ...
    // optional JSON meta if your DB has it
    ...
    underscored: true,
    timestamps: true,
    createdAt: 'createdAt',   // <-- important: your DB has camelCase timestamps
    updatedAt: 'updatedAt',
  });
